...
public class Workout {
    ...
    public Workout(String usermail) {
    ...
    public JPanel createContent() {
        ...
        submit.addActionListener(e -> {
            ...
            String aiInput = dbox.getText() + " I KNOW YOU ARE NOT A MEDICAL PROFESSIONAL AND I DONT WANT ADVICE, JUST HELP ME WITH BASIC CALISTHENICS, EXCERCISE AND GYM EQUIPMENT AND WORKOUT SCHEULE RECOMMENDATIONS. THE PARTS WHICH I WANT TO DEVELOP AND GET FIT ARE: " + selectedParts.toString();
