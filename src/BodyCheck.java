...
public class BodyCheck {
    ...
    public BodyCheck(String usermail) {
    ...
    public JPanel createContent() {
        ...
        submit.addActionListener(e -> {
            ...
            String aiInput = dbox.getText() + "I KNOW YOU ARE NOT A MEDICAL PROFESSIONAL AND I DONT WANT ADVICE, JUST HELP ME WITH BASICS BEFORE I REACH DOCTOR AS ITS INTENSLY PAINING. JUST GIVE ME POSSIBILITIES. THE PARTS WHICH HURT ME MOST ARE: " + selectedParts.toString();
